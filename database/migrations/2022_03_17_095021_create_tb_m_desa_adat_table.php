...
class CreateTbMDesaAdatTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tb_m_desa_adat', function (Blueprint $table) {
            ...
            $table->string('desadat_ttd_lokasi', 255)->nullable();
    ...
    {
        Schema::dropIfExists('tb_m_desa_adat');
    }
}
