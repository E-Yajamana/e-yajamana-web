                            ...
                            <div id="next-part" class="content" role="tabpanel" aria-labelledby="next-part-trigger">
                                <div class="container p-1 mt-2">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" id="nama_sulinggih" name="nama_sulinggih" autocomplete="off" class="form-control @error('nama_sulinggih') is-invalid @enderror" value="{{ old('nama_sulinggih') }}" placeholder="Masukan Nama Walaka">
                                    ...
                                    <div class="form-group">
                                        <label>Lokasi Rumah/Puri <span class="text-danger">*</span></label>
                                        <div class="input-group">
                                            <select name="id_griya" id="lokasi_griya" class="select2bs4 lokasi_griya @error('id_griya') is-invalid @enderror" style="width: 100%;" value="{{old('id_griya')}}">
                                                <option value="0" disabled selected>Pilih Lokasi Rumah/Puri</option>
                                                <option value="">Input Lokasi Prui/Rumah Lainnya..</option>
                                    ...
                                    <div id="formGriya"  @if (old('nama_griya') != null) class="" @else class="d-none"  @endif >
                                        ...
                                        <div class="card-body px-0">
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label>Nama Rumah/Puri <span class="text-danger">*</span></label>
                                                        <div class="input-group">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label>Alamat Lengkap Rumah/Puri <span class="text-danger">*</span></label>
                                                        <div class="input-group">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group"><label>Pemetaan Lokasi Rumah/Puri <span class="text-danger">*</span></label>
                                                        <div class="input-group">
