    ...
    <div class="container d-flex justify-content-center pt-4">
        <div class="card card-primary w-75">
            <div class="card-header bg-white text-center">
                ...
                <p class="mt-1 fs-5 mb-1">Form Pendaftaran Akun Pemangku </p>
                ...
                <div class="bs-stepper">
                    ...
                    <!-- your steps here -->
                        ...
                        <div class="step" data-target="#next-part">
                            ...
                            <span class="bs-stepper-label">Data Pemangku</span>
                            </button>
                        </div>
                    </div>
                    <div class="bs-stepper-content">
                        <form method="POST" action="{{route('auth.register.akun.pemangku.store')}}" enctype="multipart/form-data" id="formRegister">
                            @csrf
                            ...
                            <div id="next-part" class="content" role="tabpanel" aria-labelledby="next-part-trigger">
                                <div class="container p-1 mt-2">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label>Nama Pemangku <span class="text-danger">*</span></label>
                                                <div class="input-group">
                                                    <input type="text" id="nama_pemuput" name="nama_pemuput" autocomplete="off" class="form-control @error('nama_pemuput') is-invalid @enderror" value="{{ old('nama_pemuput') }}" placeholder="Masukan Nama Pemangku">
                                                    @error('nama_pemuput')
                                                        <div class="invalid-feedback text-start">
                                    ...
                                    <div class="row" id="rowPasangan">
                                        <div class="form-group col-12" id="formPasangan">
                                            <label>Pasangan Pemangku <span class="text-danger">*</span></label>
                                            <div class="input-group">
                                                <select name="id_pasangan" id="pasangan" class=" select2bs4 pasangan @error('id_pasangan') is-invalid @enderror" style="width: 100%;" value="{{old('pasangan')}}">
                                                    <option value="0" disabled selected>Pilih Pasangan Pemangku</option>
                                    ...
                                    <div class="" id="atributPemuput">
                                        ...
                                        <div class="form-group">
                                            <label>Tanggal Mawinten <span class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group">
                                            <label>Lokasi Tempat Tinggal <span class="text-danger">*</span></label>
                                            <div class="input-group">
                                                <select name="id_griya" id="lokasi_griya" class="select2bs4 lokasi_griya @error('id_griya') is-invalid @enderror" style="width: 100%;" value="{{old('id_griya')}}">
                                                    <option value="0" disabled selected>Pilih Lokasi Tempat Tinggal</option>
                                                    <option value="">Input Lokasi Tempat Tinggal Lainnya..</option>
                                    ...
                                    <div id="formGriya"  @if (old('nama_griya') != null) class="" @else class="d-none"  @endif >
                                        ...
                                        <div class="card-body px-0">
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label>Nama Tempat Tinggal <span class="text-danger">*</span></label>
                                                        <div class="input-group">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group"><label>Pemetaan Lokasi <span class="text-danger">*</span></label>
                                                        <div class="input-group">
