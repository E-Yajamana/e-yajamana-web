...
@section('content')
    <div class="container justify-content-center pt-4">
        <div class="card card-primary">
            ...
            <div class="card-body">
                <form action="{{route('auth.register.akun.pemangku.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row px-lg-4">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    <label>Lokasi Puri <span class="text-danger">*</span></label>
    ...
    <script type="text/javascript">
        ...
        $.ajax({
            ...
            success : function(response) {
                console.log(response);
                $('#lokasiGriya').empty();
                $('#lokasiGriya').append('<option value="0" disabled selected>Pilih Lokasi Puri</option>');
