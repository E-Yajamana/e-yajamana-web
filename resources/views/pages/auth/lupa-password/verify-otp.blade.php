            ...
            <div class="col-12 col-sm-6 p-4">
                <div class="card card-primary">
                    <div class="card-header bg-white text-center">
                        ...
                        <p class="login-box-msg mb-0 pb-0 px-0 pb-3 fw-bold mt-1">Verifikasi Kode OTP</p>
                    </div>
                    <div class="card-body p-2">
                        <div class="text-center p-lg-3 mb-1">
                            <p class="m-0">
                                Masukan kode rahasia yang Anda
                            </p>
                            <p class="m-0">
                                dapatkan dari E-mail yang telah
                            </p>
                            <p class="m-0">
                            ...
                            <div class="col-md">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input name="email" type="email" class="form-control @error('email') is-invalid @enderror" placeholder="Masukan Kode Rahasia">
