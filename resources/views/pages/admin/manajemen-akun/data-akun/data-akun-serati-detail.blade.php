...
@section('content')
                    ...
                    <div class="card card-info card-outline">
                        <div class="card-body box-profile m-2">
                            <div class="text-center">
                                <img class="profile-user-img img-fluid img-circle" src="{{route('get-image.profile.pemuput-karya',$dataSerati->User->id)}}" alt="User profile picture">
                            </div>
                            <h3 class="profile-username text-center mb-0 mt-2">{{$dataSerati->User->Penduduk->nama}}</h3>
                            <p class="text-muted text-center mb-0">{{ucfirst($dataSerati->User->role)}}</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter email" value="{{$dataSerati->User->email}}" disabled>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Nomor Telepon</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter email" disabled value="{{$dataSerati->User->nomor_telepon}}">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Mendaftar Pada Tanggal</label>
                                <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Password" disabled value="{{date('d F Y',strtotime($dataSerati->User->created_at))}}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card card-default">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Pendidikan" disabled value="{{$dataSerati->User->Penduduk->jenis_kelamin}}">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Pendidikan" disabled value="{{$dataSerati->User->Penduduk->golongan_darah}}">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-12">
                                    <div class="form-group mt-4">
                                        <textarea disabled name="alamat_griya" class="form-control  @error('alamat_griya') is-invalid @enderror" rows="4" placeholder="Masukan Alamat Lengkap Griya" >{{$dataSerati->User->Penduduk->alamat}} </textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer mt-2">
                            ...
                            <div class="float-lg-right">
                                <button onclick="verifikasiPemuputKarya({{$dataSerati->id}})" type="button" class="btn btn-danger btn-sm  mx-1">Hapus Data</button>
    ...
    <input id="dataLokasi" type="hidden" class="d-none" value='@json($dataSerati)'>
...
@push('js')
    <script type="text/javascript">
        let jsondataSerati = $('#dataLokasi').val();
        let dataSerati = JSON.parse(jsondataSerati)
        ...
        $(document).ready(function(){
            ...
            var marker = new L.marker([dataSerati.lat,dataSerati.lng ]);
