                    ...
                    <div class="card card-info card-outline">
                        <div class="card-body box-profile m-2">
                            <div class="text-center">
                                <img class="profile-user-img img-fluid img-circle" src="{{route('get-image.profile.pemuput-karya',$dataSulinggih->User->id)}}" alt="User profile picture">
                            </div>
                            <h3 class="profile-username text-center mb-0">I Wayan Sutama</h3>
                            <p class="text-muted text-center mb-0">Sulinggih</p>
                        </div>
                        <!-- /.card-body -->
                    </div>
                </div>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">@if ($dataSulinggih->status == 'sulinggih') Lokasi Griya @else Lokasi Rumah/Puri @endif</h3>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                <label for="exampleInputEmail1">@if ($dataSulinggih->status == 'sulinggih') Nama Griya @else Nama Rumah/Puri @endif</label>
            ...
            <div class="card card-default">
                ...
                <div class="card-footer mt-2">
                    ...
                    <div class="float-lg-right">
                        @if ($dataSulinggih->status_konfirmasi_akun == 'pending')
                        ...
                        @elseif ($dataSulinggih->status_konfirmasi_akun == 'disetujui')
                            <button onclick="verifikasiPemuputKarya({{$dataSulinggih->id}})" type="button" class="btn btn-danger btn-sm  mx-1">Hapus Data</button>
