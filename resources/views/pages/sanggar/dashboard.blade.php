        ...
        <div class="row mt-2">
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-secondary">
                    ...
                    <a href="{{route('sanggar.muput-upacara.konfirmasi-muput.index')}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-success">
                    ...
                    <a href="{{route('sanggar.muput-upacara.konfirmasi-tangkil.index')}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-info">
                        ...
                        <a href="{{route('sanggar.manajemen-reservasi.index')}}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            <!-- ./col -->
            <div class="col-lg-3 col-6">
...
<script>
    ...
    grey = '#808080';
    yellow = '#f39c12';
    showJadwal({{session()->get('id_sanggar')}},'id_sanggar');
