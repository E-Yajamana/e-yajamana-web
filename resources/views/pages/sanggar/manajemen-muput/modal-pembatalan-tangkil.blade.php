 ...
 <div class="modal fade" id="modalPembatalan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content ">
            ...
            <form id="formAlasanPembatalan" action="{{route('sanggar.muput-upacara.konfirmasi-tangkil.update.batal')}}" method="POST">
                @csrf
                @method('put')
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group px-2">
                        <label>Alasan Membatalkan ? <span class="text-danger">*</span></label>
                        <select onchange="getVal(this)" id="alasan_pembatalan" name="alasan_pembatalan" class="select2bs4 form-control " style="width: 100%;">
                             ...
                             <option value="Krama tidak melakukan penguleman">Krama tidak melakukan penguleman</option>
                             <option value="Tidak dapat melakukan reservasi">Tidak dapat melakukan reservasi</option>
...
<script>
    ...
    function batalTangkil(id_reservasi,id_krama){
        Swal.fire({
            title: 'Peringatan',
            text : 'Apakah anda yakin akan membatalkan Reservasi tersebut?',
            icon:'question',
            showDenyButton: true,
